...
public class UiPseudoScopeContextTest
        extends InjectableContextTest<TestUIPseudoScopeContextWrapper> {
    ...
    @Override
    protected Class<TestUIPseudoScopeContextWrapper> getContextType() {
        return TestUIPseudoScopeContextWrapper.class;
    }

    public static class TestUIPseudoScopeContextWrapper
            extends UIPseudoScopeContextWrapper {
        @Override
