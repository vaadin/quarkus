...
public class VaadinQuarkusNativeProcessor {
    ...
    @BuildStep
    void nativeSupport(CombinedIndexBuildItem combinedIndex,
        ...
        reflectiveClass.produce(ReflectiveClassBuildItem
                .builder(AvailableViewInfo.class, MenuData.class).constructors()
        ...
        reflectiveClass.produce(ReflectiveClassBuildItem.builder(
                classes.stream().map(classInfo -> classInfo.name().toString())
                        .toArray(String[]::new))
                .build());
